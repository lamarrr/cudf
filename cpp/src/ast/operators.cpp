...
{
#define CUDF_OPERATOR_CASE(op_name) \
  case cudf::ast::ast_operator::op_name: return "cudf::ast::ast_operator::" #op_name

  switch (op) {
    CUDF_OPERATOR_CASE(ADD);
    CUDF_OPERATOR_CASE(SUB);
    CUDF_OPERATOR_CASE(MUL);
    CUDF_OPERATOR_CASE(DIV);
    CUDF_OPERATOR_CASE(TRUE_DIV);
    CUDF_OPERATOR_CASE(FLOOR_DIV);
    CUDF_OPERATOR_CASE(MOD);
    CUDF_OPERATOR_CASE(PYMOD);
    CUDF_OPERATOR_CASE(POW);
    CUDF_OPERATOR_CASE(EQUAL);
    CUDF_OPERATOR_CASE(NULL_EQUAL);
    CUDF_OPERATOR_CASE(NOT_EQUAL);
    CUDF_OPERATOR_CASE(LESS);
    CUDF_OPERATOR_CASE(GREATER);
    CUDF_OPERATOR_CASE(LESS_EQUAL);
    CUDF_OPERATOR_CASE(GREATER_EQUAL);
    CUDF_OPERATOR_CASE(BITWISE_AND);
    CUDF_OPERATOR_CASE(BITWISE_OR);
    CUDF_OPERATOR_CASE(BITWISE_XOR);
    CUDF_OPERATOR_CASE(LOGICAL_AND);
    CUDF_OPERATOR_CASE(NULL_LOGICAL_AND);
    CUDF_OPERATOR_CASE(LOGICAL_OR);
    CUDF_OPERATOR_CASE(NULL_LOGICAL_OR);
    CUDF_OPERATOR_CASE(IDENTITY);
    CUDF_OPERATOR_CASE(IS_NULL);
    CUDF_OPERATOR_CASE(SIN);
    CUDF_OPERATOR_CASE(COS);
    CUDF_OPERATOR_CASE(TAN);
    CUDF_OPERATOR_CASE(ARCSIN);
    CUDF_OPERATOR_CASE(ARCCOS);
    CUDF_OPERATOR_CASE(ARCTAN);
    CUDF_OPERATOR_CASE(SINH);
    CUDF_OPERATOR_CASE(COSH);
    CUDF_OPERATOR_CASE(TANH);
    CUDF_OPERATOR_CASE(ARCSINH);
    CUDF_OPERATOR_CASE(ARCCOSH);
    CUDF_OPERATOR_CASE(ARCTANH);
    CUDF_OPERATOR_CASE(EXP);
    CUDF_OPERATOR_CASE(LOG);
    CUDF_OPERATOR_CASE(SQRT);
    CUDF_OPERATOR_CASE(CBRT);
    CUDF_OPERATOR_CASE(CEIL);
    CUDF_OPERATOR_CASE(FLOOR);
    CUDF_OPERATOR_CASE(ABS);
    CUDF_OPERATOR_CASE(RINT);
    CUDF_OPERATOR_CASE(BIT_INVERT);
    CUDF_OPERATOR_CASE(NOT);
    CUDF_OPERATOR_CASE(CAST_TO_INT64);
    CUDF_OPERATOR_CASE(CAST_TO_UINT64);
    CUDF_OPERATOR_CASE(CAST_TO_FLOAT64);
  }

#undef CUDF_OPERATOR_CASE
}
